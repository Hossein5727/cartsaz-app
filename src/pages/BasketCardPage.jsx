...
const BasketCardPage = () => {
  ...
  return (
    <section className={`${isShowMenu && "bg-[#c4c0c0] relative lg:bg-transparent"}`}>
      ...
      <button
        className="fixed bottom-[100px] left-[50%]  translate-x-[-50%] z-[2] btn bg-main-blue transition-all duration-150 hover:bg-main-blue border-none outline-none font-medium w-[85vw] lg:hidden"
      >
        افزودن سبد خرید
      </button>
