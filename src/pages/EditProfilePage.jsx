...
const EditProfilePage = () => {
    ...
    const onSubmit = (values) => {
        ...
        toast.success("مشخصات شما با موفقیت ویرایش شده");
        setInterval(() => {
            navigate("/home/cart/profile")
        }, 1100);
    }
        ...
        <div className="h-screen">
            ...
            <div className="mx-auto max-w-7xl px-4 py-2 flex justify-center items-center">
                <form onSubmit={formik.handleSubmit} className="flex flex-col gap-6 w-[370px]">
                    ...
                    <button
                        type="submit"
                        className="btn bg-main-blue mb-20  disabled:bg-neutral-500 disabled:text-slate-300 disabled:cursor-not-allowed transition-all duration-150 hover:bg-main-blue border-none outline-none font-medium w-full"
